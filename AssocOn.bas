...
sText = InputBox$("Extensions:", "Associate with EdSharp", sText)
...
Local sAppPath As String, sAppFolder As String
sAppPath = AppPath()
sAppFolder = fn_GetDir(sAppPath)
sAppFolder = fn_GetSfn(sAppFolder)
'msgbox sAppFolder
KeyName = sTitle
'KeyValue = Chr$(34) + sAppPath + $Path + Chr$(34) + " -I" + sAppFolder + " " + sAppFolder + "\EdSharp.rbw " + Chr$(34) + "%1" + Chr$(34)
KeyValue = Chr$(34) + sAppPath + $Path + Chr$(34) + " " + Chr$(34) + "%1" + Chr$(34)
'MsgBox keyvalue
'KeyValue = command$ + " %1"
...
If Command$ <> "/silent" Then MsgBox ("Extensions " + $Lf + sExts + $Lf + "are associated with EdSharp"), (%MB_TASKMODAL Or %MB_ICONINFORMATION Or %MB_OK), "Status"
End Function
